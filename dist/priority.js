...
export function isBackgroundWorker(env = process.env) {
 ...
 */
export function lowerPriorityIfBackgroundWorker(env = process.env, setPriority = os.setPriority) {
    if (!isBackgroundWorker(env))
        return false;
    try {
